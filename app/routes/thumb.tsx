import type { Route } from "./+types/thumb";
...
export async function loader({ request }: Route.LoaderArgs) {
  ...
  const kind = isVideoFile(resolvedPath) ? "video" : "image";
  const thumbPath = await ensureThumbnail(resolvedPath, kind);
  return createFileResponse(thumbPath);
}
